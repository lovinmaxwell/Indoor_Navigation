...
(function ($) {
    $(document).ready(function () {
       ...
       // var E = {x: 220, y: 0, r: 0, color: "rgba(192, 57, 43,0.75)"};
        ...
        var handleData = function (data) {
            ...
            if (data.length > 0) {
                ...
                for (var i = 0, j = data.length; i < j; i++) {
                    text = "<p>The receiver id is " + data[i]["receiver_id"].toString() + " received signal from " + data[i]["broadcaster_id"] + " with signal strength is " + data[i]["signal_strength"].toString() + " at " + data[i]["Time"].toString() + "</p>";
                    //console.log(data[i]);
                    infoBox(text);
        ...
        var buildingMap = function (A, B, C,  ctx) {
            var intersections = [];
