(function ($) {
    $(document).ready(function () {
        ...
        var distanceCalculation = function (signal_strength) {
            // Convert the signal strength to distance based on these datas:
            return (((signal_strength + 32)*-1) / 3);
        };
        var handleData = function (data) {
            ...
            if (data.length > 0) {
                ...
                for (var i = 0, j = data.length; i < j; i++) {
                    ...
                    //console.log(data[i]);
                    infoBox(text);
                    var distance1 = null, distance2 = null, distance3 = null;
        ...
        var buildingMap = function (A, B, C, ctx) {
            ...
            var circleIntersections = function(c0, c1) {
                var x0 = c0.x;
                var y0 = c0.y;
                var r0 = c0.r;
                var x1 = c1.x;
